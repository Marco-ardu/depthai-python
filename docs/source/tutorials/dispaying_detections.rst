...
`Demo code here <https://gitee.com/oakchina/depthai-experiments/blob/master/gen2-display-detections/1-passthrough.py>`__.
...
`Demo code here <https://gitee.com/oakchina/depthai-experiments/blob/master/gen2-display-detections/2-crop_highres.py>`__.
...
`Demo code here <https://gitee.com/oakchina/depthai-experiments/blob/master/gen2-display-detections/3-stretch_img.py>`__.
...
`Demo code here <https://gitee.com/oakchina/depthai-experiments/blob/master/gen2-display-detections/4-edit_bb.py>`__.
