...
You can also create this message on the host (`example here <https://gitee.com/oakchina/depthai-experiments/blob/cd4a1e2be64a7c0319870cf80b4be3bd0561e9a0/gen2-efficientnet-classification/main.py#L125-L127>`__)
